...
export const projects: Project[] = [
  ...
  },
  {
    ...
    longDescription: [
      '25년 이상의 병원 개원 노하우를 지닌 전문성을 시각화하고, 개원 입지부터 상권 분석, 준비 대행에 이르는 방대한 B2B 서비스를 예비 개원의들이 쉽게 탐색할 수 있도록 직관적인 플랫폼 구조 개선이 필요했습니다.',
  ...
  },
  {
    ...
    category: ['renewal'],
    contribution:
      '메인 퍼블리싱, AEO·SEO·GEO 최적화, WebP 포맷 사용 경량화, 관리자 페이지 세팅',
    period: {
      project: ['2026.06.15 - 2026.06.19'],
    },
    shortDescription:
      '기존 홈페이지 리뉴얼을 통한 웹 표준 최적화 및 로딩 속도 7초에서 3초대로 개선',
    tools: ['HTML', 'PHP', 'Gnuboard5'],
    image: '/images/projects/esarangdental/main.png',
    detailImages: [],
    longDescription: [
      '기존 홈페이지의 느린 로딩 속도와 웹 최적화 미흡 문제를 해결하기 위해 전면 리뉴얼을 진행했습니다. 사용자 경험 향상과 검색 엔진 및 지리적 정보 검색에서의 가시성을 높이는 것을 목표로 했습니다.',
