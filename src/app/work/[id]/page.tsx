...
import { ArrowLeft, Calendar, User, Wrench, ChevronRight, ChevronLeft } from 'lucide-react';
  ...
  if (!project) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-white">
        ...
        <Link href="/" className="text-brand-blue font-bold flex items-center gap-2">
    ...
    <main className="min-h-screen bg-[#fcfcfc] pb-32">
      ...
      <section className="relative h-[60vh] md:h-[80vh] overflow-hidden">
        ...
        <div className="absolute top-24 md:top-32 left-0 w-full px-6 md:px-10 flex justify-between items-center z-20">
          ...
          >
            ...
            <span className="text-sm uppercase tracking-widest font-black">Back to list</span>
          </button>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-10 pt-20 grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6">
            <div className="p-6 rounded-2xl bg-white border border-gray-100 shadow-sm">
              <div className="flex items-center gap-3 text-brand-blue mb-2">
                ...
                <span className="text-xs font-bold uppercase tracking-widest text-gray-400">Period</span>
              </div>
              <p className="text-lg font-bold text-brand-blue-dark">{project.period}</p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white border border-gray-100 shadow-sm">
              ...
              <p className="text-lg font-bold text-brand-blue-dark">{project.role}</p>
            </div>

            <div className="p-6 rounded-2xl bg-white border border-gray-100 shadow-sm">
              <div className="flex items-center gap-3 text-brand-blue mb-2">
                <Wrench className="w-5 h-5" />
                <span className="text-xs font-bold uppercase tracking-widest text-gray-400">Tools</span>
              </div>
              <div className="flex flex-wrap gap-2">
                {project.tools.map((tool, i) => (
                  <span key={i} className="text-sm font-bold text-gray-600 bg-gray-50 px-3 py-1 rounded-lg">
                    {tool}
                  </span>
                ))}
              </div>
        ...
        <div className="lg:col-span-2">
           <div className="space-y-10">
              <div>
                <h3 className="text-xs font-black text-brand-blue uppercase tracking-[0.3em] mb-4">Overview</h3>
              ...
              <div>
                <h3 className="text-xs font-black text-brand-blue uppercase tracking-[0.3em] mb-4">Challenge & Solution</h3>
      ...
      {project.detailImages && project.detailImages.length > 0 && (
        <section className="max-w-7xl mx-auto px-6 md:px-10 mt-32">
          <h3 className="text-center font-en text-sm font-black text-gray-300 uppercase tracking-[0.5em] mb-12">Visual Journey</h3>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-10 mt-40">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <h4 className="text-2xl font-bold group-hover:text-brand-blue transition-colors">{prevProject.title}</h4>
          </Link>
          ...
          >
            ...
            <h4 className="text-2xl font-bold group-hover:text-brand-blue transition-colors">{nextProject.title}</h4>
          </Link>
        </div>
      </section>
    </main>
